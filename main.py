...
if __name__ == "__main__":
    ...
    and activate=True. This method searches for emails with the specified search query and returns a list of the 
    ...
    and activate=False. This method sends an email to the specified recipient with the specified subject and 
